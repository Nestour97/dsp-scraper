# -*- coding: utf-8 -*-
"""Spotify Scraper with playwright.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18C-UgWLrkzHIc300qrJVxkZ8oOIelwob
"""

!pip -q install playwright nest_asyncio pycountry googletrans==4.0.0rc1 babel forex-python tqdm
!python -m playwright install chromium
!python -m playwright install-deps

# ---------- FULL SCRIPT (Colab) ----------
# First-time setup in a new runtime:
# !pip -q install playwright nest_asyncio pycountry googletrans==4.0.0rc1 babel forex-python tqdm openpyxl
# !python -m playwright install chromium
...
from google.colab import files
files.download("spotify_cleaned_playwright.csv")